...
import com.indeas.brewer.model.Grupo;
import com.indeas.brewer.model.Usuario;
import com.indeas.brewer.model.UsuarioGrupo;
...
public class UsuariosImpl implements UsuariosQueries {
	...
	private List<Usuario> removeDuplicados(List<Usuario> usuarioList) {
		Set<Usuario> s= new HashSet<Usuario>();
		s.addAll(usuarioList);
		usuarioList = new ArrayList<Usuario>();
		usuarioList.addAll(s);
		return usuarioList;
	}
